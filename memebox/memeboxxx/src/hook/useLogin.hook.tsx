...
export const useLogin = () => {
  ...
  const {registerOnSubmit,RegisterViaGoogleorFacebook}=useRegister()
  ...
  const signinwithGoogle=()=>{
    ...
    .then((re:any)=>{
      console.log(re)
      setSuccessMsg("Sucessfully logged in!");
      localStorage.setItem("user-login", re.user.email);
      localStorage.setItem("user-img", re.user.photoURL);
    
      RegisterViaGoogleorFacebook(re)
      setTimeout(() => {
        navigate("/") 
      }, 3000);
    }).catch((err:any)=>{
