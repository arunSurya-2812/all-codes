  ...
  return (
    <div className="policy-content">
      ...
      <p className="policy-text  u-h4">
        ...
        access and use of MeMeBox services and the MeMeBox website
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to MeMeBox.
        </li>
        <li>
        ...
        <li>
          Website refers to MeMeBox, accessible from
      ...
      <p className="policy-text  u-h4">
        By visiting this page on our website: [MeMeBox] (MeMeBox)
      </p>
    </div>
  );
};
