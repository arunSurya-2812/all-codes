...
import { Surpricebox } from "../../stateContainers/Profile/Services";
...
export const PaymentContainer = () => {
  ...
  const onPaymentSuccess = (id: any) => {
    ...
    const payment: any = {
      userid: LoggedInUser as string,
      boxid: currentUser.boxid as any,
  ...
  let currentU = JSON.parse(localStorage.getItem("box") || "{}");
  const PaymentProps = {
    name: selectedAddress.address?.name,
    amount: viewCart.totalPrice as any ||currentU.boxprice as any,
