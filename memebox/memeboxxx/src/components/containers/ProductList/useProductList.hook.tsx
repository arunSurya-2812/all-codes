...
export default function useProductList() {
  ...
  // Values From Redux
  const { navData, sliderData,profileData } = useSelector((state: IRootState) => state);
  ...
  const featurePro = profileData && profileData.boxsubscribe;

  
 
  const { name: selectedCategory, subname: selectedId } = useParams() as any;
