...
import { IInitialState, IPlans, ISubcription,ISubcribe } from "./Types";
...
export const Reducer = {
  ...
  setSubcribe: (state: IInitialState, action: PayloadAction<ISubcribe>): void => {
    state.boxsubscribe = action.payload;
  },
